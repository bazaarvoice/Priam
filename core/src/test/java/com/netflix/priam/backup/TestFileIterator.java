...
public class TestFileIterator
{
    ...
    public void testIteratorEmptySet()
    {
        ...
        MockAmazonS3Client.prefix = backupConfiguration.getBaseDir() + "/" + amazonConfiguration.getRegionName() + "/" + cassandraConfiguration.getClusterName() + "/" + factory.getInstance().getToken();
